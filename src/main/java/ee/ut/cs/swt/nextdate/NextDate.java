...
public class NextDate {
	...
	***********************************************************/
	...
	public String run(int month, int day, int year) {
		...
		{
			// To fix "Fault 1", uncomment the correct line 63 and comment out the incorrect line 62. -fixed
//			if(day <= 31) //if the day is not 31, just increment the day
			if (day < 31) //if the day is not 31, just increment the next day
				...
				tomorrowDay = 1;
				tomorrowMonth = 1;
			// To fix "Fault 2", uncomment the correct line 70 and comment out the incorrect line 69 - fixed
		...
		else if(isFebruary(month))
		{
			if(day < 28) //just a standard day - increment the day
				...
				if(day == 28) {  //if this is not a leap year, reset day and increment the day
					...
					// To seed "Fault 4", comment out the lines 99-100 - done
				//	else
				//		return "Invalid Input Date";
				}
				//
...
//		return month == 1 || month == 3 || month == 5 || month==7 || month == 8 || month == 10;
	...
	// To enable leap year functionality, first uncomment the lines starting from 184-190, and then perform the following two steps step 1: uncomment lines 85-87 and 90, step 2: uncomment lines 94-97 and 99 - fixed
